...
export default function Dashboard({ user: propUser, onUnauthorized, onNavigateToClass, onNavigateToExam }: DashboardProps) {
                ...
                {enrolledClasses.map((course) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <Button size="sm" variant="accent" onClick={() => onNavigateToClass(course.id)}>
                        Continue
                      </Button>
                    </div>
