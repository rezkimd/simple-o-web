...
export default function LandingPage({ onGetStarted, onBrowseCourses }: LandingPageProps) {
  const features = [
    {
      icon: BookOpen,
        ...
        <div className="container max-w-6xl mx-auto">
          <div className="text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
              <Button variant="accent" size="lg" className="text-lg px-8" onClick={onGetStarted}>
                Get Started
              </Button>
              <Button 
                variant="outline" 
                size="lg" 
                className="text-lg px-8 bg-primary-foreground hover:bg-primary-foreground/90"
