...
export default function ExamList({ onNavigateToExam, onNavigateToClass }: ExamListProps) {
  const exams: Exam[] = [
    {
      id: "1",
    ...
    },
    {
      id: "2",
      title: "Final Exam",
      classTitle: "Digital Marketing Strategy",
      date: "2025-10-25",
    ...
    },
    {
      ...
      classTitle: "Data Science with Python",
      date: "2025-09-15",
      duration: "60 minutes",
      questions: 15,
      status: "completed",
            ...
            {upcomingExams.map((exam) => (
              <Card
                ...
                className={`shadow-[var(--shadow-md)] ${
                  isExamSoon(exam.date) ? "border-accent border-2" : ""
                }`}
              >
                <CardHeader>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    <Button variant="accent" className="flex-1" onClick={() => onNavigateToExam(exam.id)}>
                      Start Exam
                    </Button>
                    <Button variant="outline" onClick={() => onNavigateToClass(exam.id)}>
                      Study
                    </Button>
                  </div>
                </CardContent>
